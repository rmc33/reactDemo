...
function Cube(data) {
  ...
  for(var i = 0; i < this.sides.length; ++i) {
    console.log("binding event on ", this.sides[i].getElementsByClassName('cube-image')[0]);
    bindEvent(this.sides[i].getElementsByClassName('cube-image')[0], 'mousedown', function(e) {
      console.log("mouse down ", e.target.innerText);
      e.target.className = 'cube-image mousedown';
    });
    bindEvent(this.sides[i].getElementsByClassName('cube-image')[0], 'mouseup', function(e) {
      console.log("mouse up ", e.target.innerText);
      e.target.className = 'cube-image active';
    });
